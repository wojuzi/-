...
echo "!_oem!\$OEM$codeholder_0amp;quot;
echo.
...
if %WMI_VBS% EQU 0 wmic path %_spp% where (%_ocq%) get Description %_Nul2% |findstr /V /R "^$codeholder_0amp;quot; >"!_temp!\crvRetail.txt"
...
if %_Retail% EQU 1 if %WMI_VBS% EQU 0 wmic path %_spp% where (%_ocq%) get LicenseFamily %_Nul2% |findstr /V /R "^$codeholder_0amp;quot; >"!_temp!\crvRetail.txt"
if %_Retail% EQU 1 if %WMI_VBS% NEQ 0 %_qr% %_Nul2% >"!_temp!\crvRetail.txt"
set "_qr=%_csq% %_spp% "ApplicationID='%_oApp%'" LicenseFamily"
if %WMI_VBS% EQU 0 wmic path %_spp% where "ApplicationID='%_oApp%'" get LicenseFamily %_Nul2% |findstr /V /R "^$codeholder_0amp;quot; >"!_temp!\crvVolume.txt" 2>&1
...
Add-Type -Language CSharp -TypeDefinition @"
 ...
 byte[] b85=new byte[255]; string a85="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!#$codeholder_0amp;amp;()+,-./;=?@[]^_{|}~";
...
::LjV64ZZ.g].~$t@{d@A]]9Morzyn{^]Haa6PXqwbKLn5K=K}$codeholder_0amp;amp;@gIg/3IhOC1^prAMF4=)BmjWY69$0N6b69O&K3lOEdUgoNC5^$2_xbR2t_2o9{~yLsUU=!E((RQ
...
::1pojP?f.?i9{~#M?Ei(hDKUteX#xQG2mk=k2th#k/159g00BSN004ke{d?fy]9Morzyn{^5C8zs5LQ6?00JM[XaHas/XuG4$codeholder_0amp;amp;e[U$bu/3+(M{l$N+e9/XuG9)T2$c
...
::fhb,_4&PYTWFJ8ANKu2(oAEFH)flX?_!t$codeholder_0amp;amp;/Y7rYGdKP&S84@oa!3=&vr^|phoNH4jJEU{I$3PmiL,MfP3_;8Ff7W)-J32J-n^&{)PmjMw4,i/o$K4a^~7~nS{bN$
...
::JG$codeholder_0amp;amp;u,+iEw,j=[2,r~8{W&pvo#cr8hnO(RRj2$?TV7suL(aT{!vwOCy,)urO-3DNu??TX-@ELKh-Iiarh&Ck)synN[jk~pXjyoQAlkVLFyUKT&cX2zxXW[@;@=J67
...
<html lang="en">
  ...
  <body>
    ...
    <p>Afterwards, copy <code>$oem$codeholder_0amp;lt;/code> folder to <code>sources</code> folder in the installation media (ISO/USB).</p>
